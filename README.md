...
The program allows the user to enter a matrix, performs several power iterations, and calculates an approximation of the largest eigenvalue and its corresponding eigenvector. The project was developed as part of university work.
